...
public class BloodWand extends Wand {
    ...
    public void Handle(PlayerInteractEvent e) {
        ...
        final BloodWand bWand = (BloodWand) EmpireWandPlus.wandHashMap.get("blood");
        //
        //
        //
        // Blood wand
        ...
        if (p.getInventory().getItemInMainHand().hasItemMeta() && p.getInventory().getItemInMainHand().getItemMeta().hasDisplayName() && p.getInventory()
                .getItemInMainHand().getItemMeta().getDisplayName().equals(bWand.getDisplayName())) {
            if (!p.hasPermission(bWand.getUsePermissionName())) {
            ...
            if (e.getAction() == Action.RIGHT_CLICK_AIR || e.getAction() == Action.RIGHT_CLICK_BLOCK) {
                ...
                // Spell cycling
                //
                CycleSpell(p, wand, meta, bWand.Spells, bWand);
                return;
            }
